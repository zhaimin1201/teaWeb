...
/*依赖注入*/
mainCtrIn.$inject=["$scope","$state","$rootScope","service","$interval"];
function mainCtrIn($scope,$state,$rootScope,service,$interval){
//	 service.httpRequest('http://114.67.224.249/tea/category/getCategorylist.do').then(function(data1) {
////	 		console.log(data)
//	 })
